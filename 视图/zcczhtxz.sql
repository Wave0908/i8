...
--COALESCE(ll.fkje,0) as "LJFKJE" , --累计付款金额(元)  
null as "LJFKJE" , --累计付款金额(元)                                           
...
pcm.user_yfkje as "PMCTSBCGHT_YFK",-- 预付款金额(元)                                            
pcm.user_yfkbl*100  as "PMCTSBCGHT_ZBJBL",--预付款金额比例                                            

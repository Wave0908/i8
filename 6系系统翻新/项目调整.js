function AllReady() {
	...
	*/
	...
	if (otype == $Otype.ADD || otype == $Otype.EDIT) {
		if (mstform) {
			...
			execServer("xmxx_xmtz", {
				...
				if (res.count > 0) {
					...
					mstform.getItem("user_gclx3").setValue(data[0].extendObjects.user_gclx3); //财务辅助板块
		...
		if (mstform1) {
			var pc = mstform1.queryById("PhIdOri").getValue();
			if (pc == null || pc == "" || pc == 0) {
				return false;
			};
			execServer("xmxx_xmtz", {
				...
				if (res.count > 0) {
					...
					mstform1.getItem("user_ifnbfb").setValue(data[0].extendObjects.user_ifnbfb); //实施方式
					mstform1.getItem("user_gclx1").setValue(data[0].extendObjects.user_gclx1); //财务辅助板块
					mstform1.getItem("user_gclx2").setValue(data[0].extendObjects.user_gclx2); //财务辅助板块
					mstform1.getItem("user_gclx3").setValue(data[0].extendObjects.user_gclx3); //财务辅助板块
					mstform1.getItem("PhIdType").setValue(data[0].extendObjects.user_gclx1); //财务辅助板块
					mstform1.getItem("user_pc_dept").setValue(data[0].extendObjects.user_pc_dept);
					mstform1.getItem("user_lcywdy").setValue(data[0].extendObjects.user_lcywdy); //建设模式
					mstform1.getItem("user_xmbcl").setValue(data[0].extendObjects.user_xmbcl); //项目状态
					mstform1.getItem("user_cbfs").setValue(data[0].extendObjects.user_cbfs); //资金来源
					mstform1.getItem("user_wgrq").setValue(data[0].extendObjects.user_wgrq); //经营方式
					mstform2.getItem("JobPhone").setValue(data[0].extendObjects.job_phone); //enr
					mstform1.getItem("user_mnemCodeInAccDepart").setValue(data[0].extendObjects.user_mnemcodeinaccdepart); //浪潮核算部门助记码
					mstform1.getItem("user_sfhzjy").setValue(data[0].extendObjects.user_sfhzjy); //是否合作经营
					mstform1.getItem("user_sshy").setValue(data[0].extendObjects.user_sshy); //所属行业
					mstform1.getItem("user_hyxz").setValue(data[0].extendObjects.user_hyxz); //行业性质
					mstform1.getItem("user_clfs").setValue(data[0].extendObjects.user_clfs); //承揽方式(财务)
					mstform1.getItem("user_gs_cybk").setValue(data[0].extendObjects.user_gs_cybk); //产业板块(财务)
					mstform1.getItem("user_xmgkms").setValue(data[0].extendObjects.user_xmgkms); //项目管控模式(财务)
					mstform1.getItem("user_cwbk").setValue(data[0].extendObjects.user_cwbk); //财务辅助板块
					mstform1.getItem("user_cjms").setValue(data[0].extendObjects.user_cjms); //承建模式
					mstform1.getItem("user_tsxmmc").setValue(data[0].extendObjects.user_tsxmmc); //特殊项目名称
					mstform1.getItem("user_jfdw").setValue(data[0].extendObjects.user_jfdw); //甲方单位
					mstform1.getItem("user_baxmjl").setValue(data[0].extendObjects.record_manager); //甲方单位
					mstform1.getItem("user_sfsczy").setValue(data[0].extendObjects.user_sfsczy); //是否上报中冶
					mstform1.getItem("user_sftrj").setValue(data[0].extendObjects.user_sftrj); //甲方单位
					mstform1.getItem("PhIdFiOcode").setValue(data[0].extendObjects.phidfiocode); //上报中冶时间
					mstform1.getItem("user_cwglbm").setValue(data[0].extendObjects.user_cwglbm); //甲方单位
					mstform1.getItem("user_sbzysj").setValue(data[0].extendObjects.user_sbzysj); //上报中冶时间
					mstform1.getItem("user_sbjzdxm").setValue(data[0].extendObjects.user_sbjzdxm); //省部级重点项目
					mstform1.getItem("user_yztzrq").setValue(data[0].extendObjects.user_yztzrq); //业主调整日期
					mstform1.getItem("user_tzhjgrq").setValue(data[0].extendObjects.user_tzhjgrq); //调整后竣工日期
					mstform1.getItem("user_tzhzgq").setValue(data[0].extendObjects.user_tzhzgq); //调整后总工期

					//mstform.getItem("user_szjjfzgnq").setValue(data[0].extendObjects.["user_szjjfzgnq"]); //所属经济功能区
					BatchBindCombox([mstform1.getItem("user_jfdw")]);
				};
				BatchBindCombox([
					//mstform.getItem("user_szjjfzgnq"),
					mstform1.getItem("user_pc_dept"),
					mstform1.getItem("user_xmbcl"),
					mstform1.getItem("user_ifnbfb"),
					mstform1.getItem("user_wgrq"),
					mstform1.getItem("user_lcywdy"),
					mstform1.getItem("user_baxmjl"),
					mstform1.getItem("user_cbfs"),
					mstform1.getItem("user_sshy"),
					mstform1.getItem("user_hyxz"),
					mstform1.getItem("user_clfs"),
					mstform1.getItem("user_gs_cybk"),
					mstform1.getItem("user_cwbk"),
					mstform1.getItem("user_gclx1"),
					mstform1.getItem("user_gclx2"),
					mstform1.getItem("user_gclx3"),
					mstform1.getItem("user_sbzysj"),
					mstform1.getItem("PhIdFiOcode"),
					mstform1.getItem("user_cwglbm"),
					mstform1.getItem("user_sbjzdxm")
				]);

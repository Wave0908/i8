    ...
    if (otype == $Otype.ADD || otype == $Otype.EDIT) {
        ...
        mstform.getItem('JobClass').addListener('helpselected', function () {
            ...
            execServer('gz20250311', {
                ...
                if (res.count > 0) {
                    ...
                    mstform.getItem('user_zygzdl').setValue(data[0].extendObjects.dlbm);
                    BatchBindCombox([mstform.getItem('user_zygzdl')]);
                    mstform.getItem('user_zygzzl').setValue(data[0].extendObjects.zlbm);
                    BatchBindCombox([mstform.getItem('user_zygzzl')]);
                    mstform.getItem('user_zygzxl').setValue(data[0].extendObjects.xiaolbm);
                    BatchBindCombox([mstform.getItem('user_zygzxl')]);
                    mstform.getItem('user_zzgzxxl').setValue(data[0].extendObjects.xilbm);
        ...
        mstform.getItem('user_zygzxgw').addListener('helpselected', function () {
            ...
            execServer('gz20250311', {
                ...
                if (res.count>0) {
                    const data = typeof res.data === 'string' ? JSON.parse(res.data) : res.data;
                    mstform.getItem('user_zygzdl1').setValue(data[0].extendObjects.dlbm);
                    BatchBindCombox([mstform.getItem('user_zygzdl1')]);
                    mstform.getItem('user_zygzzl1').setValue(data[0].extendObjects.zlbm);
                    BatchBindCombox([mstform.getItem('user_zygzzl1')]);
                    mstform.getItem('user_zygzxl1').setValue(data[0].extendObjects.xiaolbm);
                    BatchBindCombox([mstform.getItem('user_zygzxl1')]);
                    mstform.getItem('user_zygzxil1').setValue(data[0].extendObjects.xilbm);

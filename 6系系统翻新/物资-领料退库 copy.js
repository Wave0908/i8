function AllReady() {
    ...
    var mstform = Ext.getCmp('KC_INKSYSBZTL_Head');
    ...
    Toolbar.insert(18, {
        ...
        handler: function () {
            ...
            Ext.Ajax.request({
                ...
                url: "http://192.168.3.241:30599/new_esey/lcApi/pushCkxx?phid=" + busid,
                async: false, //同步请求
    ...
    if (!Ext.isEmpty(Toolbar)) {
        Toolbar.insert(19, {
            ...
            handler: function () {
                ...
                Ext.Ajax.request({
                    url: "http://192.168.3.241:30599/new_esey/gyl/pushData/CG_TKD/" + busid,
                    method: 'GET',
                    async: false, //同步请求
                    disableCaching: false, // 添加这行来阻止_dc参数
                    success: function (response) {
    ...
    var dgrid = Ext.getCmp('KC_INKSYSBZTL_Body');
    ...
    Toolbar.items.get('copy').on('click', function () {
        ...
        var user_zygcname = a[0].get('user_zygc_EXame');
        //所属板块字段

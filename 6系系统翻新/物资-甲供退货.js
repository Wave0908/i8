function AllReady() {
    ...
    var mstform = Ext.getCmp('KC_OUTWTCK_Head');
    ...
    var dgrid = Ext.getCmp('KC_OUTWTCK_Body');
    ...
    mstform.getItem('user_yzmc').addListener('helpselected', function (obj) {
        var yzmc = mstform.getItem('user_yzmc').getValue();
        console.log('yzmc------------>', yzmc);
        console.log('user_yzmc------------>', mstform.getItem('user_yzmc'));
    });

$NG.AllReady(function (page, { useBeforeOpen, useUpdateRow, useValuesChange, useDataIndexChange, useUpdateRows, useClick, useAction }) {
    var mstform = $NG.getCmpApi('ProjBalM4');
    var dgrid = $NG.getCmpApi('ProjBalD4');
    var Toolbar = $NG.getCmpApi('CntProjBalDetailToolBar');

    //dgrid.setMustInputCol('PhidCbs_EXName', false);
    ...
    useBeforeOpen((data) => {
        ...
        $NG.updateUI(function (updater, state) {
            updater.fieldSetForm.ProjBalM4.user_ywlx.setProps({
    ...
    useBeforeOpen((data) => {
        ...
        $NG.updateUI(function (updater, state) {
            updater.fieldSetForm.ProjBalM4.user_kkxz.setProps({
    ...
    useBeforeOpen((data) => {
        ...
        $NG.updateUI(function (updater, state) {
            ...
            updater.editGrid.ProjBalD4.user_fyxm.setProps({

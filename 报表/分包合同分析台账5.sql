...
convert(decimal(22,2),lwfbhtyht_je.htje) as 劳务分包合同原合同金额,
lwfbhtbcxy_fs.fs as 劳务分包合同补充协议合同份数,
convert(decimal(22,2),lwfbhtbcxy_je.htje) as 劳务分包合同补充协议合同金额,
lwfbhtbcxy_fsa.fs as 劳务补充单价份数,	
convert(decimal(22,2),lwfbhtbcxy_jea.htje) 	as 劳务补充单价金额,
lwfbhtbcxy_fsb.fs as 劳务调整单价份数,	
convert(decimal(22,2),lwfbhtbcxy_jeb.htje)	as 劳务调整单价金额,
lwfbhtbcxy_fsc.fs as 劳务施工范围份数,	
convert(decimal(22,2),lwfbhtbcxy_jec.htje)	as 劳务施工范围金额,
lwfbhtbcxy_fsd.fs as 劳务其他情况份数,	
convert(decimal(22,2),lwfbhtbcxy_jed.htje)	as 劳务其他情况金额,
gcfbhtbcxy_yhtfs.fs as 工程合同原合同份数,
convert(decimal(22,2),gcfbhtbcxy_yhtje.htje) as 工程合同原合同金额,
gcfbhtbcxy_fs.fs as 工程合同补充协议合同份数,
convert(decimal(22,2),gcfbhtbcxy_je.htje) as 工程合同补充协议合同金额,
gcfbhtbcxy_fsa.fs as 工程补充单价份数,	
convert(decimal(22,2),gcfbhtbcxy_jea.htje) 	as 工程补充单价金额,
gcfbhtbcxy_fsb.fs as 工程调整单价份数,	
convert(decimal(22,2),gcfbhtbcxy_jeb.htje)	as 工程调整单价金额,
gcfbhtbcxy_fsc.fs as 工程施工范围份数,	
convert(decimal(22,2),gcfbhtbcxy_jec.htje)	as 工程施工范围金额,
gcfbhtbcxy_fsd.fs as 工程其他情况份数,	
convert(decimal(22,2),gcfbhtbcxy_jed.htje)	as 工程其他情况金额,
cpjgfbhtbcxy_yhtfs.fs as 产品加工合同原合同份数,
convert(decimal(22,2),cpjgfbhtbcxy_yhtje.htje) as 产品加工合同原合同金额,
cpjgfbhtbcxy_fs.fs as 产品加工合同补充协议合同份数,
convert(decimal(22,2),cpjgfbhtbcxy_je.htje) as 产品加工合同补充协议合同金额,
cpjgfbhtbcxy_fsa.fs as 产品加工补充单价份数,	
convert(decimal(22,2),cpjgfbhtbcxy_jea.htje) 	as 产品加工补充单价金额,
cpjgfbhtbcxy_fsb.fs as 产品加工调整单价份数,	
convert(decimal(22,2),cpjgfbhtbcxy_jeb.htje)	as 产品加工调整单价金额,
cpjgfbhtbcxy_fsc.fs as 产品加工施工范围份数,	
convert(decimal(22,2),cpjgfbhtbcxy_jec.htje)	as 产品加工施工范围金额,
cpjgfbhtbcxy_fsd.fs as 产品加工其他情况份数,	
convert(decimal(22,2),cpjgfbhtbcxy_jed.htje)	as 产品加工其他情况金额,
ljwmfbhtbcxy_yhtfs.fs as 临建文明合同原合同份数,
convert(decimal(22,2),ljwmfbhtbcxy_yhtje.htje) as 临建文明合同原合同金额,
ljwmfbhtbcxy_fs.fs as 临建文明合同补充协议合同份数,
convert(decimal(22,2),ljwmfbhtbcxy_je.htje) as 临建文明合同补充协议合同金额,
ljwmfbhtbcxy_fsa.fs as 临建文明补充单价份数,	
convert(decimal(22,2),ljwmfbhtbcxy_jea.htje) 	as 临建文明补充单价金额,
ljwmfbhtbcxy_fsb.fs as 临建文明调整单价份数,	
convert(decimal(22,2),ljwmfbhtbcxy_jeb.htje)	as 临建文明调整单价金额,
ljwmfbhtbcxy_fsc.fs as 临建文明施工范围份数,	
convert(decimal(22,2),ljwmfbhtbcxy_jec.htje)	as 临建文明施工范围金额,
ljwmfbhtbcxy_fsd.fs as 临建文明其他情况份数,	
convert(decimal(22,2),ljwmfbhtbcxy_jed.htje)	as 临建文明其他情况金额,
fbht_yzhtfs.fs as 原合同份数,
convert(decimal(22,2),fbht_yzhtje.htje) as 原合同金额,
fbht_yhtfs.fs as 原合同50万元以下份数,
convert(decimal(22,2),fbht_yhtje.htje) as 原合同50万元以下金额,
convert(varchar(100),convert(decimal(22,2),(convert(decimal(22,2),isnull(fbht_yhtfs.fs,0))/convert(decimal(22,2),isnull(fbht_yzhtfs.fs,0))*100)))+'%' as 原合同50万元份数占比,
fbht_fs.fs as 原合同50_200万元份数,
convert(decimal(22,2),fbht_je.htje) as 原合同50_200万元金额,
convert(varchar(100),convert(decimal(22,2),(convert(decimal(22,2),isnull(fbht_fs.fs,0))/convert(decimal(22,2),isnull(fbht_yzhtfs.fs,0))*100)))+'%' as 原合同50_200万元份数占比,
fbht_fsa.fs as 原合同200_1000万元份数,	
convert(decimal(22,2),fbht_jea.htje) 	as 原合同200_1000万元金额,
convert(varchar(100),convert(decimal(22,2),(convert(decimal(22,2),isnull(fbht_fsa.fs,0))/convert(decimal(22,2),isnull(fbht_yzhtfs.fs,0))*100)))+'%' as 原合同200_1000万元份数占比,
fbht_fsb.fs as 原合同1000_2000万元份数,	
convert(decimal(22,2),fbht_jeb.htje)	as 原合同1000_2000万元金额,
convert(varchar(100),convert(decimal(22,2),(convert(decimal(22,2),isnull(fbht_fsb.fs,0))/convert(decimal(22,2),isnull(fbht_yzhtfs.fs,0))*100)))+'%' as 原合同1000_2000万元份数占比,
fbht_fsc.fs as 原合同2000_3000万元份数,	
convert(decimal(22,2),fbht_jec.htje)	as 原合同2000_3000万元金额,
convert(varchar(100),convert(decimal(22,2),(convert(decimal(22,2),isnull(fbht_fsc.fs,0))/convert(decimal(22,2),isnull(fbht_yzhtfs.fs,0))*100)))+'%' as 原合同2000_3000万元份数占比,
fbht_fsd.fs as 原合同3000_5000万元份数,	
convert(decimal(22,2),fbht_jed.htje)	as 原合同3000_5000万元金额,
convert(varchar(100),convert(decimal(22,2),(convert(decimal(22,2),isnull(fbht_fsd.fs,0))/convert(decimal(22,2),isnull(fbht_yzhtfs.fs,0))*100)))+'%' as 原合同3000_5000万元份数占比,
fbht_fse.fs as 原合同5000万元以上份数,	
convert(decimal(22,2),fbht_jee.htje)	as 原合同5000万元以上金额,
convert(varchar(100),convert(decimal(22,2),(convert(decimal(22,2),isnull(fbht_fse.fs,0))/convert(decimal(22,2),isnull(fbht_yzhtfs.fs,0))*100)))+'%' as 原合同5000万元份数占比,
bcxyfbhtbcxy_fs.fs as 补充协议合同补充协议合同份数,
convert(decimal(22,2),bcxyfbhtbcxy_je.htje) as 补充协议合同补充协议合同金额,
null 占比1,
bcxyfbhtbcxy_fsa.fs as 补充协议补充单价份数,	
convert(decimal(22,2),bcxyfbhtbcxy_jea.htje) 	as 补充协议补充单价金额,
null 占比2,
bcxyfbhtbcxy_fsb.fs as 补充协议调整单价份数,
convert(decimal(22,2),bcxyfbhtbcxy_jeb.htje)	as 补充协议调整单价金额,
null 占比3,
bcxyfbhtbcxy_fsc.fs as 补充协议施工范围份数,	
convert(decimal(22,2),bcxyfbhtbcxy_jec.htje)	as 补充协议施工范围金额,
null 占比4,
bcxyfbhtbcxy_fsd.fs as 补充协议其他情况份数,	
convert(decimal(22,2),bcxyfbhtbcxy_jed.htje)	as 补充协议其他情况金额,
null 占比5,
...
and year(pfm_14.check_dt)=@year
and month(pfm_14.check_dt) between @st and @en
group by 
pfm_14.sszz

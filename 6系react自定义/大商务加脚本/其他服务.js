$NG.AllReady(function (
    ...
    useAction('onClick')(() => {
        // 改1：url为表单的列表页面
        window.location.href = 'http://192.168.3.241:30599/ngweb/portal/index.html#/sub/formruntime/customform/list?AppTitle=%E5%85%B6%E4%BB%96%E6%9C%8D%E5%8A%A1&busType=lingqijiu&isSso=1&menucode=9265f708-9ce5-3cb2-d8f5-d4267ca4e947';
    }, 'u_libb')
    ...
    if (editPage.oType == "add") {
        ...
        const sourceId = $NG.getPageState().data.p_form_0000000079_m.u_lyxmchzj;
                ...
                try {
                    ...
                    if (result) {
                        ...
                        const mainTableInitValues = {
                            ...
                            cost_amount: 0,
                            ng_data_status: null,
                            u_bb: Number(data.p_form_0000000079_m.u_bb == '' ? 1 : data.p_form_0000000079_m.u_bb) + 1
                        };
                        //console.log('data.p_form_0000000079_m.u_bb:', data.p_form_0000000079_m.u_bb);
                        /**
                         * 主表需要重置的字段集合
                         */
        ...
        if (phid_pc) {
            $NG.execServer("gjdjdcqtfy", {
                ...
                if (res.count > 0) {
                    ...
                    var u_ewcbzb = data[0].extendObjects.u_ewcbzb;

$NG.AllReady(function (
    ...
    const mstform = $NG.getCmpApi('p_form_xmztzjfa_m');
    useAction('onClick')(() => {
        // 改1：url为表单的列表页面
        window.location.href = 'http://192.168.3.241:30599/ngweb/portal/index.html#/sub/formruntime/customform/list?AppTitle=%E9%A1%B9%E7%9B%AE%E6%80%BB%E4%BD%93%E8%B5%84%E9%87%91%E6%96%B9%E6%A1%88&busType=xmztzjfa&isSso=1&menucode=9265f708-9ce5-3cb2-d8f5-d4267ca4e947';
    }, 'u_libb')
    ...
    if (editPage.oType == "add") {
        ...
        const sourceId = $NG.getPageState().data.p_form_xmztzjfa_m.u_lyxmchzj;
                ...
                try {
                    ...
                    if (result) {
                        ...
                        const mainTableInitValues = {
                            ...
                            cost_amount: 0,
                            ng_data_status: null,
                            u_bb: Number(data.p_form_0000000084_m.u_bb == '' ? 1 : data.p_form_0000000084_m.u_bb) + 1
                        };
                        //console.log('data.p_form_0000000084_m.u_bb:', data.p_form_0000000084_m.u_bb);
                        /**
                         * 主表需要重置的字段集合
                         */

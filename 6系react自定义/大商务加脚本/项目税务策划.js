$NG.AllReady(function (
    ...
    const mstform = $NG.getCmpApi('p_form_0000000084_m');
    useAction('onClick')(() => {
        // 改1：url为表单的列表页面
        window.location.href = 'http://192.168.3.241:30599/ngweb/portal/index.html#/sub/formruntime/customform/list?AppTitle=%E9%A1%B9%E7%9B%AE%E7%A8%8E%E5%8A%A1%E7%AD%96%E5%88%92&busType=lingbasi&isSso=1&menucode=9265f708-9ce5-3cb2-d8f5-d4267ca4e947';
    }, 'u_libb')
    ...
    if (editPage.oType == "add") {
        ...
        const sourceId = $NG.getPageState().data.p_form_0000000084_m.u_lyxmchzj;

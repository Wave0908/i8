$NG.AllReady(function (editPage, { useValuesChange,useAction, useDataIndexChange, useUpdateRows }) {
    var mstform = $NG.getCmpApi('p_form_0000000074_m');  //

    useAction('onClick')(() => {
        // 改1：url为表单的列表页面
        window.location.href = 'http://192.168.3.241:30599/ngweb/portal/index.html#/sub/formruntime/customform/list?AppTitle=%E9%A1%B9%E7%9B%AE%E6%9D%90%E6%96%99%E8%AE%A4%E8%B4%A8%E8%AE%A4%E4%BB%B7%E8%AE%A1%E5%88%92%E8%A1%A8&busType=lingqisi&isSso=1&menucode=9265f708-9ce5-3cb2-d8f5-d4267ca4e947';
    }, 'u_libb')
    ...
    if (editPage.oType == "add") {
        ...
        const sourceId = $NG.getPageState().data.p_form_0000000074_m.u_lyxmchzj;
                ...
                try {
                    ...
                    if (result) {
                        ...
                        const mainTableInitValues = {
                            ...
                            cost_amount: 0,
                            ng_data_status: null,
                            u_bb: Number(data.p_form_0000000074_m.u_bb == '' ? 1 : data.p_form_0000000074_m.u_bb) + 1
                        };
                        //console.log('data.p_form_0000000074_m.u_bb:', data.p_form_0000000074_m.u_bb);
                        /**
                         * 主表需要重置的字段集合
                         */

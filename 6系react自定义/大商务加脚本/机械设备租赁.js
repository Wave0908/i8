$NG.AllReady(function (
   ...
   useAction('onClick')(() => {
        // 改1：url为表单的列表页面
        window.location.href = 'http://192.168.3.241:30599/ngweb/portal/index.html#/sub/formruntime/customform/list?AppTitle=%E6%9C%BA%E6%A2%B0%E8%AE%BE%E5%A4%87%E7%A7%9F%E8%B5%81&busType=lingqiliu&isSso=1&menucode=9265f708-9ce5-3cb2-d8f5-d4267ca4e947';
    }, 'u_libb')
    ...
    if (editPage.oType == "add") {
        ...
        const sourceId = $NG.getPageState().data.p_form_0000000076_m.u_lyxmchzj;
                ...
                try {
                    ...
                    if (result) {
                        ...
                        const mainTableInitValues = {
                            ...
                            cost_amount: 0,
                            ng_data_status: null,
                            u_bb: Number(data.p_form_0000000076_m.u_bb == '' ? 1 : data.p_form_0000000076_m.u_bb) + 1
                        };
                        //console.log('data.p_form_0000000076_m.u_bb:', data.p_form_0000000076_m.u_bb);
                        /**
                         * 主表需要重置的字段集合
                         */

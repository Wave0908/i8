...
$NG.AllReady(function (
    ...
    if (editPage.oType == "add") {
        //新增时，开始就隐藏
        mstform.getItem("u_ljxm").setProps({
            required: false, //required是否必输
            hidden: true
        });
        mstform.getItem("u_ljxm1").setProps({
            required: false, //required是否必输
            hidden: true
        });
        ...
        mstform.getItem("u_yfkwtms").setProps({
            required: false, //required是否必输
            hidden: true
        });
        mstform.getItem("u_lywtms").setProps({
            required: false, //required是否必输
            hidden: true
        });
        mstform.getItem("u_jswtms").setProps({
            required: false, //required是否必输
            hidden: true
        });
        mstform.getItem("u_zlwtms").setProps({
            required: false, //required是否必输
            hidden: true
        });
        mstform.getItem("u_zbjwtms").setProps({
            required: false, //required是否必输
            hidden: true
        });
    }
    if (editPage.oType == "add" || editPage.oType == "edit") {
        ...
        useValuesChange(async ({ args, form }) => {
            ...
            if (args[0].u_sfczxm.value == '01') {
                ...
                //诉讼问题
                mstform.getItem('u_sfss').setReadOnly(true);
                mstform.getItem('u_qssj').setReadOnly(true);
                mstform.getItem('u_sfyss').setReadOnly(true);
                mstform.getItem('u_sswtms').setReadOnly(true);
                mstform.getItem('u_xmjlxm').setReadOnly(true);
                mstform.getItem('u_xmjldh').setReadOnly(true);
            } else if (args[0].u_sfczxm.value == '02') {
                mstform.getItem("u_ljxm").setProps({
                    required: false, //required是否必输
                    hidden: true
                });
                ...
                //诉讼问题
                mstform.getItem('u_sfss').setReadOnly(false);
                mstform.getItem('u_qssj').setReadOnly(false);
                mstform.getItem('u_sfyss').setReadOnly(false);
                mstform.getItem('u_sswtms').setReadOnly(false);
                mstform.getItem('u_xmjlxm').setReadOnly(false);
                mstform.getItem('u_xmjldh').setReadOnly(false);
            }
        })
        ...
        //未立项的项目
        useValuesChange(({ args, form }) => {
            const u_ljxm1 = args[0].u_ljxm1.value;
            //从项目取值
            if (u_ljxm1) {
                console.log('u_ljxm1:', u_ljxm1);
                //从项目取值
                //ljsrht
                $NG.execServer("ljwtwlxxm", { phid: u_ljxm1 }, function (res) {
                    console.log("res:", res);
                    if (res.count > 0) {
                        const data = typeof res.data === 'string' ? JSON.parse(res.data) : res.data;
                        console.log("data:", data)
        ...
        }, "p_form_liangjinxiangmuwen_m.u_ljxm1");
        //清收责任人选择完带出信息
        useValuesChange(({ args, form }) => {
        ...
        //诉讼问题
        useValuesChange(({ args, form }) => {
            const u_sfxyss = args[0].u_sfxyss.value;
            if (mstform.getItem("u_sfxyss").getValue() == '01') {
                mstform.getItem("u_xyssyy").setProps({
                    required: true, //required是否必输
                    hidden: false
                });
        ...
        }, "p_form_liangjinxiangmuwen_m.u_sfxyss");
        //预付款问题
        useValuesChange(({ args, form }) => {
            if (mstform.getItem("u_yfksfaqsh").getValue() == '02') {
                mstform.getItem("u_yfkwtms").setProps({
                    required: true, //required是否必输
                    hidden: false
                });
        ...
        }, "p_form_liangjinxiangmuwen_m.u_yfksfaqsh");
        //履约问题
        useValuesChange(({ args, form }) => {
            if (mstform.getItem("u_sfulywtrwjhk").getValue() == '01') {
                mstform.getItem("u_lywtms").setProps({
                    required: true, //required是否必输
                    hidden: false
                });
        ...
        }, "p_form_liangjinxiangmuwen_m.u_sfulywtrwjhk");
        //结算问题
        useValuesChange(({ args, form }) => {
            if (mstform.getItem("u_sfyjszywtrwhk").getValue() == '01') {
                mstform.getItem("u_jswtms").setProps({
                    required: true, //required是否必输
                    hidden: false
                });
        ...
        }, "p_form_liangjinxiangmuwen_m.u_sfyjszywtrwhk");
        //质量问题
        useValuesChange(({ args, form }) => {
            if (mstform.getItem("u_sfyzlwtrwhk").getValue() == '01') {
                mstform.getItem("u_zlwtms").setProps({
                    required: true, //required是否必输
                    hidden: false
                });
        ...
        }, "p_form_liangjinxiangmuwen_m.u_sfyzlwtrwhk");
        //质保金问题
        useValuesChange(({ args, form }) => {
            if (mstform.getItem("u_zbjsfaqsh").getValue() == '02') {
                mstform.getItem("u_zbjwtms").setProps({
                    required: true, //required是否必输
                    hidden: false
                });
        ...
        }, "p_form_liangjinxiangmuwen_m.u_zbjsfaqsh");
    }
});
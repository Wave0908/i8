$NG.AllReady(function (
    ...
    useAction('onClick')(() => {
        // 改1：url为表单的列表页面
        window.location.href = 'http://192.168.3.241:30599/ngweb/portal/index.html#/sub/formruntime/customform/list?AppTitle=%E4%B8%B4%E6%97%B6%E8%AE%BE%E6%96%BD&busType=lingqiqi&isSso=1&menucode=9265f708-9ce5-3cb2-d8f5-d4267ca4e947';
    }, 'u_libb')
    ...
    if (editPage.oType == "add") {
        ...
        const sourceId = $NG.getPageState().data.p_form_0000000077_m.u_lyxmchzj;
                ...
                try {
                    ...
                    if (result) {
                        ...
                        const mainTableInitValues = {
                            ...
                            cost_amount: 0,
                            ng_data_status: null,
                            u_bb: Number(data.p_form_0000000077_m.u_bb == '' ? 1 : data.p_form_0000000077_m.u_bb) + 1
                        };
                        //console.log('data.p_form_0000000077_m.u_bb:', data.p_form_0000000077_m.u_bb);
                        /**
                         * 主表需要重置的字段集合
                         */

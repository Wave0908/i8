...
function beforeSaveEdit() {
    ...
    if (mstform.getItem('sfbcxy').getValue() == 1) {//是补充协议
        if (mstform.getItem('bg_cnt_no').getValue() == '') {//补充协议编号不为空
            ...
            //生成变更评审编号
            callServer('p_form0000000042_bg_no', [{
                'bill_no': no
            }], function (res) {
...
function allReadyEdit() { //页面编辑方法，固定写法
    ...
    console.log("mstform.getItem('is_sum'):", mstform.getItem('is_sum'));
    ...
    if (otype == $Otype.ADD || otype == $Otype.EDIT) {
        ...
        mstform.getItem('sfbcxy').addListener('change', function () { //监听表头sfbcxy字段值发生变化后立即触发
            ...
            if (mstform.getItem('sfbcxy').getValue() == 2) {
                ...
                mstform.getItem('htbm').addListener('helpselected', function () {
                    ...
                    callServer('p_form0000000042_bg_ht', [{
                        'bill_no': htmc
                    }], function (res) {
                        ...
                        mstform.getItem('bill_name').setValue(res.record[0].合同名称);
                        ...
                        BatchBindCombox([mstform.getItem('htzt'), mstform.getItem('pc_name'), mstform.getItem('xmgn'), mstform.getItem('xmlx'),
        ...
        mstform.getItem('pc_name').addListener('helpselected', function () {
            ...
            callServer('p_form0000000042_pc_name', [{
                'phid': pc_no
            }], function (res) {
                //给字段赋值
        ...
        mstform.getItem('htzt').addListener('helpselected', function () {
            ...
            if (Ext.isEmpty(dwdm)) {
                ...
                //通过SQL赋值给承揽单位编码
                callServer('p_form0000000042_fbf', [{
                    'phid': dwdm
                }], function (res) {

...
function allReadyEdit() {
    ...
    var dgrid = Ext.getCmp('p_form0000600012_dgrid');
    ...
    mstform.getItem('pc').addListener('helpselected', function () {
        ...
        callServer('data', [{
            'p_form0000600012_m.pc': pc
        }], function (res) {
            mstform.getItem('xmlx_1').setValue(res.record[0].phid_type);
            mstform.getItem('gcdd_1').setValue(res.record[0].project_address);
            mstform.getItem('empid').setValue(res.record[0].project_manager);
    ...
    if (otype == $Otype.ADD) {
        ...
        mstform.getItem('ddlbcol_1').addListener('helpselected', function () {
            ...
            if (mstform.getItem('ddlbcol_1').getValue() == '02') {
                ...
                Ext.getCmp('p_form0000600012_dgrid').setVisible(false); //设置单据体不可见
            } else {
                mstform.getItem('zjrzqk_1').setVisible(true); //设置专家论证情况可见
                Ext.getCmp('p_form0000600012_dgrid').setVisible(true); //设置单据体可见
            }
        });

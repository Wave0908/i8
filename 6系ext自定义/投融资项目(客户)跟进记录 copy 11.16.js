        ...
        mstform.getItem('u_xm').addListener('helpselected', function () {
            ...
            execServer('trzxmyxmgz', {
                ...
                if (res.count > 0) {
                   ...
                   /* //子表赋值
                    var u_gtgjsj = data1[0].extendObjects.u_gtgjsj;
                    var u_xmjkywt = data1[0].extendObjects.u_xmjkywt;
                    var u_yjyclfs = data1[0].extendObjects.u_yjyclfs;

function allReadyEdit() {
    ...
    //dgrid.getColumn('userhelp_1_EXName').getEditor.setClientSqlFilter("phid NOT IN (SELECT COALESCE(userhelp_1,'') AS userhelp_1 FROM p_form0000700233_d  UNION   SELECT COALESCE(userhelp_1, '') FROM p_form0000700233_d2)");
    dgrid.getColumn('userhelp_1_EXName').getEditor().on('beforetriggerclick', function (self) {
        self.setClientSqlFilter("phid NOT IN (SELECT COALESCE(userhelp_1,'') AS userhelp_1 FROM p_form0000700233_d  UNION   SELECT COALESCE(userhelp_1, '') FROM p_form0000700233_d2)")
    });
    //console.log("dgrid.getColumn('userhelp_1_EXName'):",dgrid.getColumn('userhelp_1_EXName'));

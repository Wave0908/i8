function allReadyEdit() {
    ...
    /**
     * 设置字段是否必填
     * @param {Array} value - 字段ID数组
     * @param {boolean} attribute - 是否必填
     */
    ...
    function xdzt(st1, st2) {
        ...
        var value1 = ['xdqmc', 'ck_dwh', 'ck_zjlbgh', 'ck_zxwyh', 'ck_xtfgld',
    ...
    function fzzt(st1, st2) {
        ...
        var value1 = ['ck_fz_dwh', 'ck_fz_zjlbgh', 'ck_fz_zxwyh', 'ck_fz_xtfgld', 'fz_ygzzdwh', 'fz_ygzzdfbrq', 'fz_fzyy'];
        var att1 = st2;
        readOnly(value1, att1);

function allReadyEdit() {
	...
	var dgrid = Ext.getCmp('p_form0000600061_dgrid');
    var dstore = dgrid.store;
	var d1grid = Ext.getCmp('p_form0000600061_d1grid');
    var d1store = d1grid.store;
	var d2grid = Ext.getCmp('p_form0000600061_d2grid');
    var d2store = d2grid.store;
	var d3grid = Ext.getCmp('p_form0000600061_d3grid');
    var d3store = d3grid.store;
	var d4grid = Ext.getCmp('p_form0000600061_d4grid');
    var d4store = d4grid.store;
    var d5grid = Ext.getCmp('p_form0000600061_d5grid');
    var d5store = d5grid.store;
	var d6grid = Ext.getCmp('p_form0000600061_d6grid');
    var d6store = dgrid.store;
	//新增时显示的字段
	//Shared();
...
*/
	...
	mstform.getItem('shch').on('beforetriggerclick', function() {
		...
		if(mstform.getItem('userhelp_char').getValue() == '') {
	...
	mstform.getItem('shqx').on('beforetriggerclick', function() {
		if(mstform.getItem('shch').getValue() == '') {

        ...
        execServer('p_form0000700176_phidempid', {
            ...
            if (res.count > 0) {
                ...
                if (data[0].extendObjects.phid_org != '324191209000001') {
                    ...
                    mstform.getItem('u_cbr').setClientSqlFilter('hemphid in (select org_id from fg_orglsit_rlzzs fol where fol.org_id in (select phid from dept where deptno in (select parent_deptno from dept where phid = (select hem.phid_dept from fg3_user fu left join hr_epm_main hem on hem.phid = fu.hrid where hem.phid = ' + phid + ')) union all select phid from dept where phid = (select hem.phid_dept from fg3_user fu left join hr_epm_main hem on hem.phid = fu.hrid where hem.phid = ' + phid + ')) or fol.parent_orgid in (select phid from dept where deptno in (select parent_deptno from dept where phid = (select hem.phid_dept from fg3_user fu left join hr_epm_main hem on hem.phid = fu.hrid where hem.phid = ' + phid + ')) union all select phid from dept where phid = (select hem.phid_dept from fg3_user fu left join hr_epm_main hem on hem.phid = fu.hrid where hem.phid = ' + phid + ')) union all select phid from dept where phid = 548191210000021 and exists (select 1 from dept where parent_deptno = (select parent_deptno from dept where phid = (select hem.phid_dept from fg3_user fu left join hr_epm_main hem on hem.phid = fu.hrid where hem.phid = ' + phid + ')) and parent_deptno = \'A1001.3007\') union all select phid from dept where deptno = \'A1001.3017\' and exists (select 1 from dept where parent_deptno = (select parent_deptno from dept where phid = (select hem.phid_dept from fg3_user fu left join hr_epm_main hem on hem.phid = fu.hrid where hem.phid = ' + phid + ')) and parent_deptno = \'A1001.3005\') union all select phid from dept where parent_deptno = \'A1001.3017\' and exists (select 1 from dept where parent_deptno = (select parent_deptno from dept where phid = (select hem.phid_dept from fg3_user fu left join hr_epm_main hem on hem.phid = fu.hrid where hem.phid = ' + phid + ')) and parent_deptno = \'A1001.3005\') union all select phid from dept where (deptno = \'A1001.3037\' or deptno = \'A1001.3043\') and exists (select 1 from dept where parent_deptno = (select parent_deptno from dept where phid = (select hem.phid_dept from fg3_user fu left join hr_epm_main hem on hem.phid = fu.hrid where hem.phid = ' + phid + ')) and parent_deptno = \'A1001.3010\') union all select phid from dept where (parent_deptno = \'A1001.3037\' or deptno = \'A1001.3043\') and exists (select 1 from dept where parent_deptno = (select parent_deptno from dept where phid = (select hem.phid_dept from fg3_user fu left join hr_epm_main hem on hem.phid = fu.hrid where hem.phid = ' + phid + ')) and parent_deptno = \'A1001.3010\') union all select phid from dept where deptno = \'A1001.3035\' and exists (select 1 from dept where parent_deptno = (select parent_deptno from dept where phid = (select hem.phid_dept from fg3_user fu left join hr_epm_main hem on hem.phid = fu.hrid where hem.phid = ' + phid + ')) and parent_deptno = \'A1001.3011\') union all select phid from dept where parent_deptno = \'A1001.3035\' and exists (select 1 from dept where parent_deptno = (select parent_deptno from dept where phid = (select hem.phid_dept from fg3_user fu left join hr_epm_main hem on hem.phid = fu.hrid where hem.phid = ' + phid + ')) and parent_deptno = \'A1001.3011\'))');
                    //mstform.getItem('u_cbr').setClientSqlFilter('hemphid in (select phid from dept where phid = (select hem.phid_dept from fg3_user fu left join hr_epm_main hem on hem.phid = fu.hrid where hem.phid = ' + phid + ') or hemphid in (select phid from dept where deptno in( select parent_deptno from dept where phid = ( select hem.phid_dept from fg3_user fu left join hr_epm_main hem on hem.phid = fu.hrid where hem.phid = ' + phid + ') )))');
                }
            }
        })

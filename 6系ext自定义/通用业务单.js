function allReadyEdit() {
    ...
    mstform.getItem('u_dbdj').on('beforetriggerclick', function (_eOp, _ignoreBeforeEvent) { //帮助窗口打开前事件
        ...
        console.log("u_dbck:",u_dbck);

        if (u_dbck == '18') {
            mstform.getItem('u_dbdj').setClientSqlFilter(' phid_transno = ' + u_dbck + ' and phid not in (select u_dbdj from p_form0000700341_m where u_dbdj is not null)');
        }

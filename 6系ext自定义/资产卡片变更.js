...
function allReadyEdit() {
    ...
    var dgrid = Ext.getCmp('p_form0000700043_d');
    ...
    mstform.on('dataready', function () {
        ...
        console.log("dataready:", phid_org);
    })
    /*只在新增修改界面使用start*/
            ...
            if (Ext.isEmpty(zclx)) {
                ...
                setTimeout(function () {
                    ...
                    help = Ext.create('Ext.ng.MultiRichHelp', {
                        ...
                        outFilter: {
                            'p_form0000000225_m_change.phid_org': phid_org,
                            'p_form0000000225_m_change.zclx': zclx
                        }
                    }, 500);
                    execServer('gbyb', {}, function (res) {

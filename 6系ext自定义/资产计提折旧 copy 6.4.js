                                ...
                                if (res.status != 'success') { //判断取数状态
                                    ...
                                    for (let i = 0; i < res.count; i++) {
                                        arr.push({
                                            ...
                                            u_jzbwb: resData[i].extendObjects.u_bz,
                                            u_jzbwb_EXName: resData[i].extendObjects.u_bz_name,
                                            u_hl: resData[i].extendObjects.u_hl,
                                            u_jzbwbyz: resData[i].extendObjects.u_jzbwbyz,
                                            u_jzbwbljzj: resData[i].extendObjects.u_jzbwbljzj,
                                            u_jzbwbjz: resData[i].extendObjects.u_jzbwbjz,
                                            u_jzbwbsj: resData[i].extendObjects.u_jzbwbsj,
                                            u_jzbwbhsje: resData[i].extendObjects.u_jzbwbhsje
                                        })
                                    }
